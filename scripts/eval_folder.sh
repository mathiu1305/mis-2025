#!/usr/bin/env bash
# Recorre todas las carpetas new_*_dataset dentro del dataset raíz,
# calcula medias de Greedy y Greedy-probabilista (con alpha),
# y genera dos CSV: results_greedy_all.csv y results_prob_aXX_all.csv
#
# Uso:
